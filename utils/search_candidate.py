...
candidate_index_path = dir_path + '/../data/candidate_skills_vector_10k.csv'
...
def find_best_candidate_by_skills(skills, number_of_result = 10):
    ...
    chunksize = 10 ** 5
    for candidates in pd.read_csv(candidate_index_path,  error_bad_lines=True, chunksize=chunksize):
